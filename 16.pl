...
# cmon perl un-experimental this feature already
# it fixes almost every problem i have with refs
# which are the main terrible thing of perl 5
# it's PATTERN MATCHING! and i love it
...
for \my @test (@tests) {
    (\my @before, \my @middle, \my @after) = @test;
    my $opnum = $middle[0];
...
sub looks_like {
    ...
    (\my @before, \my @middle, \my @after) = @_;
